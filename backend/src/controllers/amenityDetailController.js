...
class AmenityDetailController {
  ...
  getAmenityDetailById = expressAsyncHandler(async (req, res) => {
    const detail = await AmenityDetailService.getAmenityDetailById(
      req.params.id
    );
    res.json(detail);
  });
  ...
  getAmenitiesByRoomType = expressAsyncHandler(async (req, res) => {
    const amenities = await AmenityDetailService.getAmenitiesByRoomType(
  ...
  updateAmenityDetail = expressAsyncHandler(async (req, res) => {
    const updatedDetail = await AmenityDetailService.updateAmenityDetail(
      req.params.id,
      req.body
    );
